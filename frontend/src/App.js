...
import "./App.css";
import { Eye, Zap, Clock, TrendingUp, Shield, Globe, Cpu, Brain, Star, Crown, ShoppingCart, Sparkles, Bot, Moon, Scroll, Palette, Vault, Gem, Twitter } from "lucide-react";
            ...
            <Tabs defaultValue="upgrades" className="tabs-container">
              ...
              <TabsContent value="store" className="store-grid">
                {STORE_ITEMS.map(item => {
                  ...
                  return (
                    <Card key={item.id} className={`store-card ${purchased ? 'purchased' : ''} ${item.type === 'evidence' ? 'evidence-vault' : ''} ${item.type === 'ultimate' ? 'ultimate-vault' : ''}`}>
